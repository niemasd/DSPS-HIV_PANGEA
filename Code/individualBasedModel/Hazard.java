 ...
 * @version 3 June 2014 - EBH - Added birth/death hazards, and included in total hazard calc
 */
public class Hazard {
	...
	public double getTreatmentHazard() {
		return treatmentHazard;
	}
	...
	public void setTreatmentHazard(double treatmentHazard) {
		this.treatmentHazard = treatmentHazard;
	}
	...
	public double getTotalHazard() {
		if (totalHazard == -1) {
			totalHazard = exposedToInfectedHazard + infectOtherHazard + recoveryHazard + migrationHazard
					+ treatmentHazard + birthHazard + deathHazard;
		}
		return totalHazard;
	}
