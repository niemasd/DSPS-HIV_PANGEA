...
public class Logger {
	...
	/**
	 * creates a new logger that can take lists of EventType
	 * @author Emma Hodcroft 14 March 2014
	 */
	public Logger(String path, String name, String ext, List<EventType> recordEventType) {
		this.path = path;
		this.name = name;
		this.ext  = ext;
		setRecordType(recordEventType);
