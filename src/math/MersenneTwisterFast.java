...
class MersenneTwisterFast implements Serializable {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // class methods
    // use these to enforce synchronisation
    ...
    public static int getInt(int n) {
    	return DEFAULT_INSTANCE.nextInt(n);
    }
    ...
    public static double getGaussian() {
    	return DEFAULT_INSTANCE.nextGaussian();
    }
    
    // SJL 27 Nov 2012
    public static void initialiseWithSeed(int seed) {
    	DEFAULT_INSTANCE.setSeed((long)seed);
    }
    
    // SJL 17 June 2013 - I think this is right
    public static long getSeed() {
    	return (DEFAULT_INSTANCE.mt[0]);
    }
